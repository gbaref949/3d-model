...
export function Avatar(props) {
  const group = useRef();
  const { nodes, materials } = useGLTF('models/65eeba100d14e501b713ead4.glb');

  const { animations: helloAnimation } = useFBX('animations/Hello.fbx');

  helloAnimation[0].name = 'Hello';

  const { actions } = useAnimations(helloAnimation, group);
...
useGLTF.preload('models/65eeba100d14e501b713ead4.glb');
